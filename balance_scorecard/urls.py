...
urlpatterns = [
    ...
    #path('detalle/<int:pk>', views.DetalleGerente, name='detalle'),
    #Crud Informacion Kpi
    #path('crear_info', views.IndicadorCrearInfoView.as_view(), name='crear_info'),
    ...
    #path('charts/', views.HomeView.as_view(),name='home-2'),
